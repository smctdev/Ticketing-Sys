...
function Help() {
  ...
  useEffect(() => {
    const fetchHelp = async () => {
      try {
        const automationResponse = await api.get("/getAllAutomationHelp");
        const branchResponse = await api.get("/getAllBranchHelp");
...
{(userRole === 1) && (
      ...
      {(userRole === 4 || userRole === 5) && (
        <div className="mt-10 mb-96 ">
          ...
          <div className="-mt-10 grid justify-self-center">
            <div className="shadow-sky-200 relative z-10 mt-10 h-[95%] w-full max-w-5xl justify-self-center rounded-lg bg-white p-1 shadow md:w-[100%] lg:w-[100%]">
              <CardBody>
                <Typography variant="h6" className="border-3d mb-4 ml-6">
            ...
            <div className="shadow-sky-200 relative z-10 mt-10 h-[95%] w-full max-w-5xl  justify-self-center rounded-lg bg-white p-1 shadow md:w-[100%] lg:w-[100%]">
              <CardBody>
                ...
                <div className="video-container border-3d flex justify-center">
                  <iframe
                    title="How to create a ticket?"
