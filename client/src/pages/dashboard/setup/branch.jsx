...
export function Setupbranch() {
  ...
  useEffect(() => {
    const fetchBranches = async () => {
      try {
        const response = await api.get(`/getAllBranchesTable?${queryParams}`);
    ...
    <div className="mt-12 mb-8 flex flex-col gap-12">
      ...
      {isViewModalOpen && (
        <ViewBranchModal
          ...
          branchIdToView={showBranchIdToView}
        />
      )}
      ...
      {isEditModalOpen && (
        <EditBranchModal
          ...
          branchIdToEdit={showBranchIdToEdit}
